...
class GenericStrongStructuralRolesDistanceFactory<U>
    implements DistanceBuilderFactory<U> {
    ...
    return new AbstractDistanceOperatorBuilder<T, U>() {
      ...
      Operator<U, IntDistanceMatrix> makeConcrete() {
        return (ConstantDistanceOperatorBase<U>) in -> RoleDistanceAlgorithms
            .strongStructuralEquivalenceDistance(numNodes, positionView, p -> 1);
      }

      @Override
      Operator<U, IntDistanceMatrix> makeConcrete(Comparator<? super T> comparator) {
        return (ConstantDistanceOperatorBase<U>) in -> RoleDistanceAlgorithms
            .strongStructuralEquivalenceDistance(numNodes, positionView, comparator, p -> 1);
      }
      ...
      Operator<U, IntDistanceMatrix> makeConcrete(ToIntFunction<? super T> penalty) {
        return (ConstantDistanceOperatorBase<U>) in -> RoleDistanceAlgorithms
            .strongStructuralEquivalenceDistance(numNodes, positionView, penalty);
      }
      ...
      Operator<U, IntDistanceMatrix> makeConcrete(Comparator<? super T> comparator,
        ...
        return (ConstantDistanceOperatorBase<U>) in -> RoleDistanceAlgorithms
            .strongStructuralEquivalenceDistance(numNodes, positionView, comparator, penalty);
      }
      ...
      Operator<U, IntDistanceMatrix> makeConcrete(
        ...
        return (ConstantDistanceOperatorBase<U>) in -> RoleDistanceAlgorithms
            .strongStructuralEquivalenceDistance(numNodes, positionView, substitutionCost);
      }
      ...
      Operator<U, IntDistanceMatrix> makeConcrete(Comparator<? super T> comparator,
          ToIntBiFunction<? super T, ? super T> substitutionCost) {
        return (ConstantDistanceOperatorBase<U>) in -> RoleDistanceAlgorithms
            .strongStructuralEquivalenceDistance(numNodes, positionView, comparator,
                substitutionCost);
      }
