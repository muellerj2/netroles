...
public class EquivalenceBundleServiceProvider implements RoleOperatorBundleService {
  ...
  public <U, V extends RoleOperatorBuilderFactory<U>, W extends GenericRoleOperatorBuilderFactory<U>, X extends BasicRoleOperatorFactory<U>, Y> RoleOperatorFactoryBundle<U, V, W, X, Y> getBundle(
    ...
    if (ConstMapping.OfInt.class.equals(structureType)
        && (basicRoleOperatorFactory == null
            || basicRoleOperatorFactory.isAssignableFrom(BasicRoleOperatorFactory.class))
      ...
      return (RoleOperatorFactoryBundle<U, V, W, X, Y>) new EquivalenceFactoryBundle();
    }
    return null;
  }
