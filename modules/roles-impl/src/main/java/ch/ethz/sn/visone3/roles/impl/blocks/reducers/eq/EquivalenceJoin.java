...
class EquivalenceJoin implements RoleReducer<ConstMapping.OfInt> {
  ...
  public OfInt combine(OfInt first, OfInt second) {
    return Equivalences.supremum(first, second);
  }

  @Override
  public OfInt refiningCombine(OfInt base, OfInt first, OfInt second) {
    return Equivalences.infimum(base, Equivalences.supremum(first, second));
  }

  @Override
  public OfInt coarseningCombine(OfInt base, OfInt first, OfInt second) {
    return Equivalences.supremum(base, Equivalences.supremum(first, second));
  }
