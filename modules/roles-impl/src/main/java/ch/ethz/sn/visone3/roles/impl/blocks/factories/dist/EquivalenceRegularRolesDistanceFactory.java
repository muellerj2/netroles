...
public class EquivalenceRegularRolesDistanceFactory
    extends VariableBuilderFactoryBase<VariableDistanceBuilderFactory<ConstMapping.OfInt>>
  ...
  public <T> DistanceOperatorBuilder<T, ConstMapping.OfInt> of(int numNodes,
    ...
    return new AbstractDistanceOperatorBuilder<T, ConstMapping.OfInt>() {
      ...
      @Override
      Operator<ConstMapping.OfInt, IntDistanceMatrix> makeConcrete() {
        if (p >= numNodes) {
          return (IsotoneDistanceOperatorBase<ConstMapping.OfInt>) in -> RoleDistanceAlgorithms
