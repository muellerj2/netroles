...
abstract class RelationalTraitsAdjustableOperator implements RoleOperator<BinaryRelation> {

  private final OperatorTraits traits;

  public RelationalTraitsAdjustableOperator(OperatorTraits traits) {
    this.traits = traits;
  }
