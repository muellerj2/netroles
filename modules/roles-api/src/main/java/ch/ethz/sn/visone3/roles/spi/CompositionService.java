...
/**
 * Service providing generic methods to combine operators in various ways.
 */
public interface CompositionService {
   ...
   * @param <T>   the role structure type of the derived role operator.
   * @param <U>   the role structure type of the inner role operator.
   ...
   */
  <T, U> Operator<T, U> parallel(Reducer<U> reducer,
